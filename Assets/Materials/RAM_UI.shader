    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
				...
				color = color * step(0.5,_RAMState-1) + lerp(hovCol0, hovCol1,t) * step(_RAMState-1,0.5);
				
				//Locked
				color = color * step(0.5,_RAMState) + _LockedColor * step(_RAMState,0.5);
